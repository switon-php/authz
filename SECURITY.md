...
Security fixes are provided for **currently supported release lines** of `switon/authz` (`switon/authz` on Packagist).
...
1. **GitHub private vulnerability reporting (preferred)**  
   [Report a vulnerability](https://github.com/switon-php/authz/security/advisories/new)
